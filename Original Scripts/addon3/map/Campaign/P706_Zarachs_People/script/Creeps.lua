-- gives gold reward for killing creep gropus 
...
State
{
	...
	OnOneTimeEvent ---------------------------------------------------------------------------------------------------- 01 wolf
	{
		...
		Actions =
		{
			...
			FigureOutcry	{TextTag = GoldOutcry[10], Tag = noFigure},
		},
	},
	...
	{
		EventName = ">>> Creep group vanished: 18 spider	 <<<",
		Conditions = 
		{
			SetUpdateInterval {Steps = freq},
	...
	OnOneTimeEvent ---------------------------------------------------------------------------------------------------- 27 bear at the chest
	{
		...
		Conditions = 
		{
			...
			FigureIsDead	{Tag = "Drops_Bear_Claw"},
		},
		Actions =
		{
			AvatarGoldGive	{Player = "default", Amount = 10 },
	...
	OnOneTimeEvent ---------------------------------------------------------------------------------------------------- 39 wolf
	{
		...
		Actions =
		{
			...
			FigureOutcry	{TextTag = GoldOutcry[20], Tag = noFigure},
		},
	},
	...
	OnOneTimeEvent ---------------------------------------------------------------------------------------------------- 45 spider
	{
		...
		Actions =
		{
			...
			FigureOutcry	{TextTag = GoldOutcry[50], Tag = noFigure},
		},
	},
