...
State
{
	...
	OnEvent
	{
		...
		Actions =
		{
			...
			FigureNpcSpawnToEntity	{Tag = "Spawned_NL1_02_01", Player = pl, Level = lvl, UnitId = uWarrior,			TargetTag = PointSpawnA, Team = tm}, 
			FigureNpcSpawnToEntity	{Tag = "Spawned_NL1_02_02", Player = pl, Level = lvl, UnitId = uWarrior,			TargetTag = PointSpawnC, Team = tm},

			FigureRunToEntity {Tag = "Spawned_NL1_02_01", TargetTag = PointTeleportIn},
			FigureRunToEntity {Tag = "Spawned_NL1_02_02", TargetTag = PointTeleportIn},
		},
...
State
{
	...
	OnEvent
	{
		...
		Conditions = 
		{
			...
			OR
			{
				FigureIsInRangeToEntity	{Tag = "Spawned_NL1_02_01", TargetTag = PointTeleportIn, Range = rg},
				FigureIsInRangeToEntity	{Tag = "Spawned_NL1_02_02", TargetTag = PointTeleportIn, Range = rg},
			},
		},
		Actions =
		{
			FigureTeleportToEntity	{Tag = "Spawned_NL1_02_01", TargetTag = PointTeleportOut},
			FigureTeleportToEntity	{Tag = "Spawned_NL1_02_02", TargetTag = PointTeleportOut},
			
			FigurePathGoto { Goto = FigureRunToEntity {Tag = "Spawned_NL1_02_01", TargetTag = Point09}, Tags = {Point03, Point04, Point05, Point06, Point07, Point08}},
			FigurePathGoto { Goto = FigureRunToEntity {Tag = "Spawned_NL1_02_02", TargetTag = Point09}, Tags = {Point03, Point04, Point05, Point06, Point07, Point08}},
		},
	...
	OnEvent
	{
		...
		Conditions = 
		{
			...
			FigureIsDead	{Tag = "Spawned_NL1_02_01"},
			FigureIsDead	{Tag = "Spawned_NL1_02_02"},
		},
		Actions =
		{
		},
...
State
{
	...
	OnEvent
	{
		...
		Conditions = 
		{
			...
			OR
			{
				FigureIsInRangeToEntity	{Tag = "Spawned_NL1_02_01", TargetTag = Point06, Range = rgToMerge},
				FigureIsInRangeToEntity	{Tag = "Spawned_NL1_02_02", TargetTag = Point06, Range = rgToMerge},
			},
		},
		Actions =
		{
			FigurePlayerTransfer	{Tag = "Spawned_NL1_02_01", Player = plMerge},
			FigurePlayerTransfer	{Tag = "Spawned_NL1_02_02", Player = plMerge},
		},
		GotoState = "SPAWNER_READY",
	},
