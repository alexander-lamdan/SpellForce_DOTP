...
--				OR
	--			{
			...
			ObjectSpawn	{ObjectId = 1948, X = 41.3275, Y = 31.5037, Direction = 180, Tag = "Point1_Flag"},
		...
		OnEvent
		{
			...
			ObjectVanish	{Tag = "Point1_Flag"},
			ObjectSpawn	{ObjectId = 1896, X = 41.3275, Y = 31.5037, Direction = 180, Tag = "Point1_Flag"},
			MinimapAlertSetToEntity	{Tag = "Control_Point01", Type = 2},
			EffectStart	{Tag = "Point1_Flag", File = "Effect_Spawn_Unit"},
			},
		...
		OnEvent
		{
			...
			ObjectSpawn	{ObjectId = 1948, X = 307.381, Y = 294.595, Direction = 0, Tag = "Point2_Flag"},
		...
		OnEvent
		{
			...
			ObjectVanish	{Tag = "Point2_Flag"},
			ObjectSpawn	{ObjectId = 1896, X = 307.381, Y = 294.595, Direction = 0, Tag = "Point2_Flag"},
			MinimapAlertSetToEntity	{Tag = "Control_Point02", Type = 2},
			EffectStart	{Tag = "Point2_Flag", File = "Effect_Spawn_Unit"},
			},
...
--				OR
	--			{
			...
			ObjectSpawn	{ObjectId = 1948, X = 48.3969, Y = 291.898, Direction = 90, Tag = "Point3_Flag"},
		...
		OnEvent
		{
			...
			ObjectVanish	{Tag = "Point3_Flag"},
			ObjectSpawn	{ObjectId = 1896, X = 48.3969, Y = 291.898, Direction = 90, Tag = "Point3_Flag"},
			MinimapAlertSetToEntity	{Tag = "Control_Point03", Type = 2},
			EffectStart	{Tag = "Point3_Flag", File = "Effect_Spawn_Unit"},
			},
...
--				OR
	--			{
			...
			ObjectSpawn	{ObjectId = 1948, X = 290.409, Y = 46.6957, Direction = 270, Tag = "Point4_Flag"},
		...
		OnEvent
		{
			...
			ObjectVanish	{Tag = "Point4_Flag"},
			ObjectSpawn	{ObjectId = 1896, X = 290.409, Y = 46.6957, Direction = 270, Tag = "Point4_Flag"},
			MinimapAlertSetToEntity	{Tag = "Control_Point04", Type = 2},
			EffectStart	{Tag = "Point4_Flag", File = "Effect_Spawn_Unit"},
			},
		...
		OnEvent
		{
			...
			Conditions = 
			{
				...
				FigureTeamIsInRangeToEntity	{Team = "1", Range = 15, TargetTag = "Control_Point05"},
				FigureTeamIsNotInRangeToEntity	{Team = "2", Range = 15, TargetTag = "Control_Point05"},
				
				FigureTeamIsNotInRangeToEntity	{Team = "tm_Neutral", Range = 15, TargetTag = "Control_Point05"},			
			...
			ObjectSpawn	{ObjectId = 1948, X = 169.344, Y = 154.676, Direction = 0, Tag = "Point5_Flag"},
		...
		OnEvent
		{
			...
			Conditions = 
			{
				...
				FigureTeamIsInRangeToEntity	{Team = "2", Range = 15, TargetTag = "Control_Point05"},
				FigureTeamIsNotInRangeToEntity	{Team = "1", Range = 15, TargetTag = "Control_Point05"},
				FigureTeamIsNotInRangeToEntity	{Team = "tm_Neutral", Range = 15, TargetTag = "Control_Point05"},
			...
			ObjectVanish	{Tag = "Point5_Flag"},
			ObjectSpawn	{ObjectId = 1896, X = 169.344, Y = 154.676, Direction = 0, Tag = "Point5_Flag"},
			MinimapAlertSetToEntity	{Tag = "Control_Point05", Type = 2},
			EffectStart	{Tag = "Point5_Flag", File = "Effect_Spawn_Unit"},
			},
