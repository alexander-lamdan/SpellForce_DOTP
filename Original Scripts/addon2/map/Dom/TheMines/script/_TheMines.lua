...
{	
	...
	OnEvent
		...
		OnEvent
		{
			...
			MapTimerStart	{Name = "mt_Control_Point03Pts"},
			MapValueAdd	{Name = "mv_team2Points", Value = 10},
			TeamResourceStoneGive {Team = "2", Amount = 30}, 
			TeamResourceSilverGive {Team = "2", Amount = 50}, 
			TeamResourceLenyaGive {Team = "2", Amount = 20},
...
--				OR
	--			{
			...
			ObjectSpawn	{ObjectId = 1948, X = 268.122, Y = 314.195, Direction = 0, Tag = "Point1_Flag"},
		...
		OnEvent
		{
			...
			ObjectVanish	{Tag = "Point1_Flag"},
			ObjectSpawn	{ObjectId = 1896, X = 268.122, Y = 314.195, Direction = 0, Tag = "Point1_Flag"},
			MinimapAlertSetToEntity	{Tag = "Control_Point01", Type = 2},
			EffectStart	{Tag = "Point1_Flag", File = "Effect_Spawn_Unit"},
			},
		...
		OnEvent
		{
			...
			ObjectSpawn	{ObjectId = 1948, X = 184.125, Y = 175.471, Direction = 0, Tag = "Point2_Flag"},
		...
		OnEvent
		{
			...
			ObjectVanish	{Tag = "Point2_Flag"},
			ObjectSpawn	{ObjectId = 1896, X = 184.125, Y = 175.471, Direction = 0, Tag = "Point2_Flag"},
			MinimapAlertSetToEntity	{Tag = "Control_Point02", Type = 2},
			EffectStart	{Tag = "Point2_Flag", File = "Effect_Spawn_Unit"},
			},
...
--				OR
	--			{
			...
			ObjectSpawn	{ObjectId = 1948,X = 91.6437, Y = 43.9919, Direction = 180, Tag = "Point3_Flag"},
		...
		OnEvent
		{
			...
			ObjectVanish	{Tag = "Point3_Flag"},
			ObjectSpawn	{ObjectId = 1896,X = 91.6437, Y = 43.9919, Direction = 180, Tag = "Point3_Flag"},
			MinimapAlertSetToEntity	{Tag = "Control_Point03", Type = 2},
			EffectStart	{Tag = "Point3_Flag", File = "Effect_Spawn_Unit"},
			},
