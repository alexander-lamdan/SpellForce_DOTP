...
--				OR
	--			{
			...
			ObjectSpawn	{ObjectId = 1948, X = 364.669, Y = 370.306, Direction = 0, Tag = "Point1_Flag"},
		...
		OnEvent
		{
			...
			ObjectVanish	{Tag = "Point1_Flag"},
			ObjectSpawn	{ObjectId = 1896, X = 364.669, Y = 370.306, Direction = 0, Tag = "Point1_Flag"},
			MinimapAlertSetToEntity	{Tag = "Control_Point01", Type = 2},
			EffectStart	{Tag = "Point1_Flag", File = "Effect_Spawn_Unit"},
			},
		...
		OnEvent
		{
			...
			ObjectSpawn	{ObjectId = 1948, X = 390.014, Y = 393.977, Direction = 0, Tag = "Point2_Flag"},
		...
		OnEvent
		{
			...
			ObjectVanish	{Tag = "Point2_Flag"},
			ObjectSpawn	{ObjectId = 1896, X = 390.014, Y = 393.977, Direction = 0, Tag = "Point2_Flag"},
			MinimapAlertSetToEntity	{Tag = "Control_Point02", Type = 2},
			EffectStart	{Tag = "Point2_Flag", File = "Effect_Spawn_Unit"},
			},
...
--				OR
	--			{
			...
			ObjectSpawn	{ObjectId = 1948, X = 405.244, Y = 373.15, Direction = 270, Tag = "Point3_Flag"},
		...
		OnEvent
		{
			...
			ObjectVanish	{Tag = "Point3_Flag"},
			ObjectSpawn	{ObjectId = 1896, X = 405.244, Y = 373.15, Direction = 270, Tag = "Point3_Flag"},
			MinimapAlertSetToEntity	{Tag = "Control_Point03", Type = 2},
			EffectStart	{Tag = "Point3_Flag", File = "Effect_Spawn_Unit"},
			},
...
--				OR
	--			{
			...
			ObjectSpawn	{ObjectId = 1948, X = 387.015, Y = 354.804, Direction = 180, Tag = "Point4_Flag"},
		...
		OnEvent
		{
			...
			ObjectVanish	{Tag = "Point4_Flag"},
			ObjectSpawn	{ObjectId = 1896, X = 387.015, Y = 354.804, Direction = 180, Tag = "Point4_Flag"},
			MinimapAlertSetToEntity	{Tag = "Control_Point04", Type = 2},
			EffectStart	{Tag = "Point4_Flag", File = "Effect_Spawn_Unit"},
