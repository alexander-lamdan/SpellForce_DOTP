...
{	
	...
	OnEvent
	 ...
	 --dom points		
		...
		OnEvent
		{
			...
			ObjectSpawn	{ObjectId = 1948, X = 179.885, Y = 302.987, Direction = 0, Tag = "Point1_Flag"},
		...
		OnEvent
		{
			...
			ObjectVanish	{Tag = "Point1_Flag"},
			ObjectSpawn	{ObjectId = 1896, X = 179.885, Y = 302.987, Direction = 0, Tag = "Point1_Flag"},
			MinimapAlertSetToEntity	{Tag = "Control_Point01", Type = 2},
			EffectStart	{Tag = "Point1_Flag", File = "Effect_Spawn_Unit"},
			},
		...
		OnEvent
		{
			...
			ObjectSpawn	{ObjectId = 1948, X = 179.885, Y = 174.15, Direction = 130, Tag = "Point2_Flag"},
		...
		OnEvent
		{
			...
			ObjectVanish	{Tag = "Point2_Flag"},
			ObjectSpawn	{ObjectId = 1896, X = 179.885, Y = 174.15, Direction = 130, Tag = "Point2_Flag"},
			MinimapAlertSetToEntity	{Tag = "Control_Point02", Type = 2},
			EffectStart	{Tag = "Point2_Flag", File = "Effect_Spawn_Unit"},
			},
	...
	--			FigureTeamIsNotInRangeToEntity	{Team = "tm_Neutral", Range = 15, TargetTag = "Control_Point03"},			
			...
			ObjectSpawn	{ObjectId = 1948, X = 175.859, Y = 212.211, Direction = 130, Tag = "Point3_Flag"},
		...
		{		
			...
			ObjectVanish	{Tag = "Point3_Flag"},
			ObjectSpawn	{ObjectId = 1896, X = 175.859, Y = 212.211, Direction = 130, Tag = "Point3_Flag"},
			MinimapAlertSetToEntity	{Tag = "Control_Point03", Type = 2},
			EffectStart	{Tag = "Point3_Flag", File = "Effect_Spawn_Unit"},
			},
		...
		OnEvent
		{
			...
			ObjectSpawn	{ObjectId = 1948, X = 177.584, Y = 137.665, Direction = 180, Tag = "Point4_Flag"},
		...
		OnEvent
		{
			...
			ObjectVanish	{Tag = "Point4_Flag"},
			ObjectSpawn	{ObjectId = 1896, X = 177.584, Y = 137.665, Direction = 180, Tag = "Point4_Flag"},
			MinimapAlertSetToEntity	{Tag = "Control_Point04", Type = 2},
			EffectStart	{Tag = "Point4_Flag", File = "Effect_Spawn_Unit"},
			},
		...
		OnEvent
		{
			...
			ObjectSpawn	{ObjectId = 1948, X = 178.383, Y = 38.1525, Direction = 180, Tag = "Point5_Flag"},
		...
		OnEvent
		{
			...
			ObjectVanish	{Tag = "Point5_Flag"},
			ObjectSpawn	{ObjectId = 1896, X = 178.383, Y = 38.1525, Direction = 180, Tag = "Point5_Flag"},
			MinimapAlertSetToEntity	{Tag = "Control_Point05", Type = 2},
			EffectStart	{Tag = "Point5_Flag", File = "Effect_Spawn_Unit"},
			},
