...
--				OR
	--			{
			...
			ObjectSpawn	{ObjectId = 1948, X = 255.389, Y = 82.8912, Direction = 0, Tag = "Point1_Flag"},
		...
		OnEvent
		{
			...
			ObjectVanish	{Tag = "Point1_Flag"},
			ObjectSpawn	{ObjectId = 1896, X = 255.389, Y = 82.8912, Direction = 0, Tag = "Point1_Flag"},
			MinimapAlertSetToEntity	{Tag = "Control_Point01", Type = 2},
			EffectStart	{Tag = "Point1_Flag", File = "Effect_Spawn_Unit"},
			},
		...
		OnEvent
		{
			...
			ObjectSpawn	{ObjectId = 1948, X = 272.601, Y = 295.857, Direction = 0, Tag = "Point2_Flag"},
		...
		OnEvent
		{
			...
			ObjectVanish	{Tag = "Point2_Flag"},
			ObjectSpawn	{ObjectId = 1896, X = 272.601, Y = 295.857, Direction = 0, Tag = "Point2_Flag"},
			MinimapAlertSetToEntity	{Tag = "Control_Point02", Type = 2},
			EffectStart	{Tag = "Point2_Flag", File = "Effect_Spawn_Unit"},
			},
...
--				OR
	--			{
			...
			ObjectSpawn	{ObjectId = 1948, X = 497.699, Y = 59.2226, Direction = 0, Tag = "Point3_Flag"},
		...
		OnEvent
		{
			...
			ObjectVanish	{Tag = "Point3_Flag"},
			ObjectSpawn	{ObjectId = 1896, X = 497.699, Y = 59.2226, Direction = 0, Tag = "Point3_Flag"},
			MinimapAlertSetToEntity	{Tag = "Control_Point03", Type = 2},
			EffectStart	{Tag = "Point3_Flag", File = "Effect_Spawn_Unit"},
			},
...
--				OR
	--			{
			...
			ObjectSpawn	{ObjectId = 1948, X = 502.03, Y = 295.955, Direction = 0, Tag = "Point4_Flag"},
		...
		OnEvent
		{
			...
			ObjectVanish	{Tag = "Point4_Flag"},
			ObjectSpawn	{ObjectId = 1896, X = 502.03, Y = 295.955, Direction = 0, Tag = "Point4_Flag"},
			MinimapAlertSetToEntity	{Tag = "Control_Point04", Type = 2},
			EffectStart	{Tag = "Point4_Flag", File = "Effect_Spawn_Unit"},
			},
		...
		OnEvent
		{
			...
			ObjectSpawn	{ObjectId = 1948, X = 388.408, Y = 179.395, Direction = 0, Tag = "Point5_Flag"},
		...
		OnEvent
		{
			...
			ObjectVanish	{Tag = "Point5_Flag"},
			ObjectSpawn	{ObjectId = 1896, X = 388.408, Y = 179.395, Direction = 0, Tag = "Point5_Flag"},
			MinimapAlertSetToEntity	{Tag = "Control_Point05", Type = 2},
			EffectStart	{Tag = "Point5_Flag", File = "Effect_Spawn_Unit"},
			},
