...
for i = 1, 3 do
	...
	OnOneTimeEvent
	{
		...
		Actions = 
		{
			...
			AvatarXPGive	{Player = sPlayerName, Amount = 250},
			AvatarFlagSetTrue   {Player = sPlayerName, Name = "af_P346_GotDocument01"},
		},
	};
	OnOneTimeEvent
	{
		...
		Actions = 
		{
			AvatarItemMiscGive	{Player = sPlayerName, ItemId = Item.Misc.Dokument, Amount = 1},
			AvatarXPGive	{Player = sPlayerName, Amount = 250},
			AvatarFlagSetTrue   {Player = sPlayerName, Name = "af_P346_GotDocument02"},
		},
	};
	OnOneTimeEvent
	{
		...
		Actions = 
		{
			AvatarItemMiscGive	{Player = sPlayerName, ItemId = Item.Misc.Dokument, Amount = 1},
			AvatarXPGive	{Player = sPlayerName, Amount = 250},
			AvatarFlagSetTrue   {Player = sPlayerName, Name = "af_P346_GotDocument03"},
		},
	};
	OnOneTimeEvent
	{
		...
		Actions = 
		{
			AvatarItemMiscGive	{Player = sPlayerName, ItemId = Item.Misc.Dokument, Amount = 1},
			AvatarXPGive	{Player = sPlayerName, Amount = 250},
			AvatarFlagSetTrue   {Player = sPlayerName, Name = "af_P346_GotDocument04"},
		},
	};
	OnOneTimeEvent
	{
		...
		Actions = 
		{
			AvatarItemMiscGive	{Player = sPlayerName, ItemId = Item.Misc.Dokument, Amount = 1},
			AvatarXPGive	{Player = sPlayerName, Amount = 250},
			AvatarFlagSetTrue   {Player = sPlayerName, Name = "af_P346_GotDocument05"},
		},
	};
	OnOneTimeEvent
	{
		...
		Actions = 
		{
			AvatarItemMiscGive	{Player = sPlayerName, ItemId = Item.Misc.Dokument, Amount = 1},
			AvatarXPGive	{Player = sPlayerName, Amount = 250},
			AvatarFlagSetTrue   {Player = sPlayerName, Name = "af_P346_GotDocument06"},
		},
	};
	OnOneTimeEvent
	{
		...
		Actions = 
		{
			AvatarItemMiscGive	{Player = sPlayerName, ItemId = Item.Misc.Dokument, Amount = 1},
			AvatarXPGive	{Player = sPlayerName, Amount = 250},
			AvatarFlagSetTrue   {Player = sPlayerName, Name = "af_P346_GotDocument07"},
		},
	};
	OnOneTimeEvent
	{
		...
		Actions = 
		{
			AvatarItemMiscGive	{Player = sPlayerName, ItemId = Item.Misc.Dokument, Amount = 1},
			AvatarXPGive	{Player = sPlayerName, Amount = 250},
			AvatarFlagSetTrue   {Player = sPlayerName, Name = "af_P346_GotDocument08"},
		},
	};
	  
	-- ********************************************************************
	-- solver der gesamtquest, sobald man mind. 12 Bärenmarken besitzt
	-- ********************************************************************
	OnOneTimeEvent
	{
		EventName = "Player"..i.."EnoughHonorDocumentsCollected",
		Conditions = 
		{
			QuestIsActive	{Player = sPlayerName, Quest = "CoopSpyDocuments"},
