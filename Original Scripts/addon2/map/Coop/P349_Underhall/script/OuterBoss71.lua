...
State
{
	...
	OnOneTimeEvent
	{
		Conditions =
		{
			OR
			{
				AvatarHasItemMisc {Player = "pl_Human1", ItemId = 409, Amount = 1},
				AvatarHasItemMisc {Player = "pl_Human2", ItemId = 409, Amount = 1},
				AvatarHasItemMisc {Player = "pl_Human3", ItemId = 409, Amount = 1},
			},
			OR
			{
