State
{
	...
	OnEvent
	{
		Conditions = 
		{
			...
			PlayerHasResourceLenya	{Player = "pl_Human3", Amount = 500},
			PlayerHasResourceSilver	{Player = "pl_Human3", Amount = 500},
			PlayerHasResourceStone	{Player = "pl_Human3", Amount = 500},
		...
		Actions = 
		{
			...
			PlayerResourceLenyaTake		{Player = "pl_Human3", Amount = 500},
			PlayerResourceSilverTake	{Player = "pl_Human3", Amount = 500},
			PlayerResourceStoneTake		{Player = "pl_Human3", Amount = 500},
	...
	OnEvent
	{
		Conditions = 
		{
			...
			OR
			{
				PlayerHasNotResourceLenya	{Player = "pl_Human3", Amount = 500},
				PlayerHasNotResourceSilver	{Player = "pl_Human3", Amount = 500},
				PlayerHasNotResourceStone	{Player = "pl_Human3", Amount = 500},
			},
