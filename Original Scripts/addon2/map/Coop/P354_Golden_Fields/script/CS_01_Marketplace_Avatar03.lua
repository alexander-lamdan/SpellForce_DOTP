--************************************************************
--**														**
--**		Coop Golden Fields Marketplace	Avatar03 		**
--**														**
--************************************************************

-- Figuren die gerendert werden
local _tRenderList3 = CutsceneFigureRenderList{Tag = "EvilMage"}
...
State
{
	...
	OnCutsceneFigureRespawnEvent	-- Kamera auf Avatar
	{
		...
		Conditions =
		{
			MapFlagIsTrue	{Name = "mf_Cutscene01Avatar03"},
		},
		Actions =
		{
			_tRenderList3,
...
State
{
	...
	OnOneTimeEvent	-- Avatar: Cutscene01
	{
		...
		Actions =
		{
			CutsceneSay {TextTag = "Cutscene01", Tag = "pl_Human3Avatar"},
			EntityTimerStart {Name = "et_CStimer"},
		},
...
State
{
	...
	OnOneTimeEvent	-- Avatar: Cutscene02
	{
		...
		Actions =
		{
			CutsceneSay {TextTag = "Cutscene02", Tag = "pl_Human3Avatar"},
			EntityTimerStart {Name = "et_CStimer"},
		},
