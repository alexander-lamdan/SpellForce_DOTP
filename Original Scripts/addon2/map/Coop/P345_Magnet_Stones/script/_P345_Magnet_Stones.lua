...
for i = 1, 3 do
	...
	OnOneTimeEvent
	{
		...
		Actions = 
		{
			...
			AvatarXPGive	{Player = sPlayerName, Amount = 200},
			AvatarFlagSetTrue   {Player = sPlayerName, Name = "af_P345_GotDocument01"},
		},
	};
	OnOneTimeEvent
	{
		...
		Actions = 
		{
			AvatarItemMiscGive	{Player = sPlayerName, ItemId = Item.Misc.Dokument, Amount = 1},
			AvatarXPGive	{Player = sPlayerName, Amount = 200},
			AvatarFlagSetTrue   {Player = sPlayerName, Name = "af_P345_GotDocument02"},
		},
	};
	OnOneTimeEvent
	{
		...
		Actions = 
		{
			AvatarItemMiscGive	{Player = sPlayerName, ItemId = Item.Misc.Dokument, Amount = 1},
			AvatarXPGive	{Player = sPlayerName, Amount = 200},
			AvatarFlagSetTrue   {Player = sPlayerName, Name = "af_P345_GotDocument03"},
		},
	};
	OnOneTimeEvent
	{
		...
		Actions = 
		{
			AvatarItemMiscGive	{Player = sPlayerName, ItemId = Item.Misc.Dokument, Amount = 1},
			AvatarXPGive	{Player = sPlayerName, Amount = 200},
			AvatarFlagSetTrue   {Player = sPlayerName, Name = "af_P345_GotDocument04"},
		},
	};
	OnOneTimeEvent
	{
		...
		Actions = 
		{
			AvatarItemMiscGive	{Player = sPlayerName, ItemId = Item.Misc.Dokument, Amount = 1},
			AvatarXPGive	{Player = sPlayerName, Amount = 200},
			AvatarFlagSetTrue   {Player = sPlayerName, Name = "af_P345_GotDocument05"},
		},
	};
	OnOneTimeEvent
	{
		...
		Actions = 
		{
			AvatarItemMiscGive	{Player = sPlayerName, ItemId = Item.Misc.Dokument, Amount = 1},
			AvatarXPGive	{Player = sPlayerName, Amount = 200},
			AvatarFlagSetTrue   {Player = sPlayerName, Name = "af_P345_GotDocument06"},
		},
	};
	OnOneTimeEvent
	{
		...
		Actions = 
		{
			AvatarItemMiscGive	{Player = sPlayerName, ItemId = Item.Misc.Dokument, Amount = 1},
			AvatarXPGive	{Player = sPlayerName, Amount = 200},
			AvatarFlagSetTrue   {Player = sPlayerName, Name = "af_P345_GotDocument07"},
		},
	};
	OnOneTimeEvent
	{
		...
		Actions = 
		{
			AvatarItemMiscGive	{Player = sPlayerName, ItemId = Item.Misc.Dokument, Amount = 1},
			AvatarXPGive	{Player = sPlayerName, Amount = 200},
			AvatarFlagSetTrue   {Player = sPlayerName, Name = "af_P345_GotDocument08"},
		},
	};
