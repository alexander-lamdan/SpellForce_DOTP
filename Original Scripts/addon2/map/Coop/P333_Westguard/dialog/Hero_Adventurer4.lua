...
_uStateBeginDelayTrans = GdsCreateTransition (_uStateBeginDelay, _uState2, "StateBeginDelay", "State_2_T3", "Dialog")
	...
	_uStateBeginDelayTrans:AddAction (CScriptActionSay("Hero_Adventurer4", "P333_DLG_HEROADVENTURER4_001", "Guter Freund! Hättet Ihr wohl Verwendung für einen weiteren Streiter in euren Reihen?", 100, 16777215))
...
_uState6Trans1 = GdsCreateTransition (_uState3, _uState6, "State_3", "State_6_T1", "Dialog")
	...
	_uState6Trans1:AddAction (CScriptActionSay("pl_HumanAvatar", "P333_DLG_HEROADVENTURER4_003PC", "Dann sorge ich dafür, dass Ihr mehr als genug erlebt!", 102, 16777215))
