...
_uState2Trans1 = GdsCreateTransition (_uState2, _uState2, "State_2", "State_2_T1", "Dialog")
	...
	_uState2Trans1:AddAction (CScriptActionChoice("P333_DLG_HEROMAGE_002PC", "Euren zukünftigen Arbeitgeber.", 1, 16777215))
...
_uState4Trans1 = GdsCreateTransition (_uState2, _uState4, "State_2", "State_4_T1", "Dialog")
	...
	_uState4Trans1:AddAction (CScriptActionSay("pl_HumanAvatar", "P333_DLG_HEROMAGE_002PC", "Euren zukünftigen Arbeitgeber.", 99, 16777215))
	...
	_uState4Trans1:AddAction (CScriptActionSay("Hero_Mage", "P333_DLG_HEROMAGE_004", "Gebe zu, ich habe viel über Euch gehört. Ihr habt einen guten Ruf inerhalb der Hand!", 103, 16777215))
	_uState4Trans1:AddAction (CScriptActionSay("Hero_Mage", "P333_DLG_HEROMAGE_005", "Wenn Ihr einen geschulten Magier der Elemente brauchen könnt, dann habt ihr ihn jetzt! Auf Gedeih oder Verderb!", 104, 16777215))
