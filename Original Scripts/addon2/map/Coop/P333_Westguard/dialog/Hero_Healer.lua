...
_uStateBeginDelayTrans = GdsCreateTransition (_uStateBeginDelay, _uState2, "StateBeginDelay", "State_2_T3", "Dialog")
	...
	_uStateBeginDelayTrans:AddAction (CScriptActionSay("Hero_Healer", "P333_DLG_HEROHEALER_001", "Aha! Unser neuer Freund, ich habe schon viel über Euch gehört! Ihr scheint ein spannendes Leben zu führen!", 100, 16777215))
...
_uState4Trans1 = GdsCreateTransition (_uState2, _uState4, "State_2", "State_4_T1", "Dialog")
	...
	_uState4Trans1:AddAction (CScriptActionSay("Hero_Healer", "P333_DLG_HEROHEALER_003", "Gut denn, warum nicht! Meine heilende Kräfte gehören Euch, Blut meines Blutes!", 102, 16777215))
