...
for i = 1, 3 do
	...
	OnOneTimeEvent
	{
		...
		Actions = 
		{
			...
			AvatarXPGive	{Player = sPlayerName, Amount = 300},
			AvatarFlagSetTrue   {Player = sPlayerName, Name = "af_P347_GotDocument01"},
		},
	};
	OnOneTimeEvent
	{
		...
		Actions = 
		{
			AvatarItemMiscGive	{Player = sPlayerName, ItemId = Item.Misc.Dokument, Amount = 1},
			AvatarXPGive	{Player = sPlayerName, Amount = 300},
			AvatarFlagSetTrue   {Player = sPlayerName, Name = "af_P347_GotDocument02"},
		},
	};
	OnOneTimeEvent
	{
		...
		Actions = 
		{
			AvatarItemMiscGive	{Player = sPlayerName, ItemId = Item.Misc.Dokument, Amount = 1},
			AvatarXPGive	{Player = sPlayerName, Amount = 300},
			AvatarFlagSetTrue   {Player = sPlayerName, Name = "af_P347_GotDocument03"},
		},
	};
	OnOneTimeEvent
	{
		...
		Actions = 
		{
			AvatarItemMiscGive	{Player = sPlayerName, ItemId = Item.Misc.Dokument, Amount = 1},
			AvatarXPGive	{Player = sPlayerName, Amount = 300},
			AvatarFlagSetTrue   {Player = sPlayerName, Name = "af_P347_GotDocument04"},
		},
	};
	OnOneTimeEvent
	{
		...
		Actions = 
		{
			AvatarItemMiscGive	{Player = sPlayerName, ItemId = Item.Misc.Dokument, Amount = 1},
			AvatarXPGive	{Player = sPlayerName, Amount = 300},
			AvatarFlagSetTrue   {Player = sPlayerName, Name = "af_P347_GotDocument05"},
		},
	};
	OnOneTimeEvent
	{
		...
		Actions = 
		{
			AvatarItemMiscGive	{Player = sPlayerName, ItemId = Item.Misc.Dokument, Amount = 1},
			AvatarXPGive	{Player = sPlayerName, Amount = 300},
			AvatarFlagSetTrue   {Player = sPlayerName, Name = "af_P347_GotDocument06"},
		},
	};
	OnOneTimeEvent
	{
		...
		Actions = 
		{
			AvatarItemMiscGive	{Player = sPlayerName, ItemId = Item.Misc.Dokument, Amount = 1},
			AvatarXPGive	{Player = sPlayerName, Amount = 300},
			AvatarFlagSetTrue   {Player = sPlayerName, Name = "af_P347_GotDocument07"},
		},
	};
	OnOneTimeEvent
	{
		...
		Actions = 
		{
			AvatarItemMiscGive	{Player = sPlayerName, ItemId = Item.Misc.Dokument, Amount = 1},
			AvatarXPGive	{Player = sPlayerName, Amount = 300},
			AvatarFlagSetTrue   {Player = sPlayerName, Name = "af_P347_GotDocument08"},
		},
	};
