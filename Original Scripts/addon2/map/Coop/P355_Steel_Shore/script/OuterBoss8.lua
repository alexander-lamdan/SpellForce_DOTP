...
State
{
	...
	OnOneTimeEvent
	{
		Conditions =
		{
			OR
			{
				AvatarHasItemMisc {Player = "pl_Human1", ItemId = 410, Amount = 1},
				AvatarHasItemMisc {Player = "pl_Human2", ItemId = 410, Amount = 1},
				AvatarHasItemMisc {Player = "pl_Human3", ItemId = 410, Amount = 1},
			},
			OR
			{
	...
	OnOneTimeEvent
	{
		Conditions =
		{
			OR
			{
				AND
				{
					AvatarHasNotItemMisc {Player = "pl_Human1", ItemId = 410, Amount = 1},
					AvatarHasNotItemMisc {Player = "pl_Human2", ItemId = 410, Amount = 1},
					AvatarHasNotItemMisc {Player = "pl_Human3", ItemId = 410, Amount = 1},
				},
				AND
				{
